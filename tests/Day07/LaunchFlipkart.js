    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 9:
                    _a.sent();
                    return [2 /*return*/, "The title of the page is ".concat(title)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _b = (_a = console).log;
                    return [4 /*yield*/, performAction("https://www.flipkart.com/", "screenshot")];
                case 1:
                    _b.apply(_a, [_e.sent()]);
                    _d = (_c = console).log;
                    return [4 /*yield*/, performAction("https://www.flipkart.com/", "title")];
                case 2:
                    _d.apply(_c, [_e.sent()]);
                    return [2 /*return*/];
            }
